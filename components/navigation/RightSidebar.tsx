...
const topQuestions = [
  ...
  { _id: "2", title: "How to use Tailwind CSS?" },
  { _id: "3", title: "How to use Next.js?" },
  { _id: "4", title: "How to use TypeScript?" },
  { _id: "5", title: "How to use Prisma?" },
];
...
const RightSidebar = () => {
  return (
    <section
      ...
      top-0 flex h-screen w-[350px] flex-col gap-6 overflow-y-auto border-l p-6 shadow-light-300
